...
public enum ${javaClassName} {
    ...
    <#list monstersMap as monsterEnumName, monsterProps>${monsterEnumName}("${monsterProps.codeName}", "${monsterProps.Name}", "${monsterProps.AFKtype}", ${monsterProps.RespawnTime?c}, ${monsterProps.MonsterHPTotal?c}, ${monsterProps.ExpType?c}, ${monsterProps.ExpGiven?c}, ${monsterProps.Defence?c}, ${monsterProps.Damages[0]?c})<#sep>,
    </#sep></#list>;
